// accel_B — registre identifiant (lecture seule)
// r_data = { 0xDEAD, STREAM_ID[23:0], 0xBBBBBB }
// accel1 (STREAM_ID=1) -> 0xDEAD_000001_BBBBBB
// accel2 (STREAM_ID=2) -> 0xDEAD_000002_BBBBBB
(* keep_hierarchy = "yes" *)
module accel_wrap #(
    ...
    // -------------------------------------------------------------------------
    // SINK DFX : tous les signaux d'entrée doivent avoir un fanout dans le pblock
    // -------------------------------------------------------------------------
