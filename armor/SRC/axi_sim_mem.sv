      ...
      forever begin
        ...
        if (aw_queue.size() != 0) begin
          ...
          if (axi_req_i.w_valid) begin
            ...
            mon_w.valid = 1'b1;
            mon_w.addr = addr;
            mon_w.data = axi_req_i.w.w_data;
            //mon_w.id = aw_queue[0].w_id;
            //mon_w.user = aw_queue[0].w_user;
            ...
            for (shortint unsigned
                ...
                i_byte++) begin
              if (axi_req_i.w.w_strb[i_byte]) begin
                automatic addr_t byte_addr = (addr / StrbWidth) * StrbWidth + i_byte;
                mem[byte_addr] = axi_req_i.w.w_data[i_byte*8+:8];
            ...
            if (w_cnt == aw_queue[0].len) begin
              ...
              assert (axi_req_i.w.w_last) else $error("Expected last beat of W burst!");
              ...
              assert (!axi_req_i.w.w_last) else $error("Did not expect last beat of W burst!");
              w_cnt++;
            end
          end
        end
